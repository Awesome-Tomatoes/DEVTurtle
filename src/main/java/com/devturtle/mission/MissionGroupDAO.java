...
public class MissionGroupDAO {
	...
	public ArrayList<ObjectiveVO> selectAllMission() {
	...
	// 모든 그룹 미션 조회
	public ArrayList<Integer> selectAllMissionGroupNum() {
		
		DBManager o = OracleDBManager.getInstance();
		
		ArrayList<Integer> mlist = new ArrayList<Integer>();
		
		String sql = "select objective_id from objective where type = 'G'\r\n"
	...
	public ArrayList<MissionJoinGroupVO> selectMissionGroup(int groupid) {
		...
		String sql = "SELECT \r\n"
				...
				+ "    FROM (\r\n"
				+ "        SELECT \r\n"
				+ "            og.group_id, TO_CHAR(og.success_date, 'YYYY-MM-DD') as success_date, o.objective_id, \r\n"
				+ "            o.contents, o.points  \r\n"
				+ "        FROM \r\n"
				+ "            objective_group og\r\n"
				+ "        JOIN \r\n"
	...
	public ArrayList<MissionJoinGroupVO> selectMissionGroupHistory(int groupid) {
		...
		String sql = "SELECT GROUP_ID, NAME, SUCCESS_DATE, SUM(POINTS) AS TOTAL_POINTS, COUNT(SUCCESS_DATE) AS CNT\r\n"
				...
				+ "    g.name, \r\n"
				+ "    o.objective_id, \r\n"
				+ "    TO_CHAR(og.success_date, 'YYYY-MM-DD') as success_date, \r\n"
				+ "    o.contents, \r\n"
				+ "    o.points\r\n"
				+ "FROM \r\n"
				+ "    objective_group og\r\n"
	...
	public ArrayList<MissionJoinGroupVO> selectMissionGroupChart(int groupid) {
			...
			String sql = "SELECT group_id, name, objective_id, success_date, contents, points, COUNT(contents) AS cnt\r\n"
					...
					+ "    FROM (\r\n"
					+ "        SELECT og.group_id, TO_CHAR(og.success_date, 'YYYY-MM-DD') as success_date, o.objective_id, o.contents, o.points  \r\n"
	...
	public ArrayList<MissionJoinGroupVO> selectMissionGroupBadge(int groupid) {
		...
		String sql = "select g.group_id, g.name, o.contents, o.badge_link, o.points, TO_CHAR(og.success_date, 'YYYY-MM-DD') as success_date\r\n"
