...
🖥️ **화면 설계**
- Figma를 이용해 **화면을 기획 및 설계**하고 **협업** 했습니다.
- 화면 설계서는 다음과 같습니다:
...
- 프로젝트의 일정 관리는 **일일 체크리스트 (Daily Checklist)** / **일일 브리핑 (Daily Briefing)** 을 통해 이루어집니다.
    
- **일일 브리핑**은 **스크럼(Scrum)** 방식에 따라 진행되며, 팀원들은 각자의 작업 진행 상황을 빠르게 공유하고 문제를 해결합니다.
    
    | 칸반보드 |
    | --- |
    | <img src="https://github.com/user-attachments/assets/98dca779-3ae5-4618-8aca-d1dedce359c6" width="600" height="300" class="jop-noMdConv"> |
